(function (global, factory) {
    ...
    function maskedClass(mask) {
        ...
        if (mask instanceof RegExp) return g.PicPayCCMask.MaskedRegExp;
        if (isString(mask)) return g.PicPayCCMask.MaskedPattern;
        if (mask instanceof Date || mask === Date) return g.PicPayCCMask.MaskedDate;
        if (mask instanceof Number || typeof mask === 'number' || mask === Number) return g.PicPayCCMask.MaskedNumber;
        if (Array.isArray(mask) || mask === Array) return g.PicPayCCMask.MaskedDynamic;
        // $FlowFixMe
        if (mask.prototype instanceof g.PicPayCCMask.Masked) return mask;
        // $FlowFixMe
        if (mask instanceof Function) return g.PicPayCCMask.MaskedFunction;

        console.warn('Mask not found for mask', mask); // eslint-disable-line no-console
        return g.PicPayCCMask.Masked;
    }
    ...
    function createMask(opts) {
        ...
        if (mask instanceof g.PicPayCCMask.Masked) return mask;
    ...
    /** {@link InputMask} */
    PicPayCCMask.InputMask = InputMask;

    /** {@link Masked} */
    PicPayCCMask.Masked = Masked;
    /** {@link MaskedPattern} */
    PicPayCCMask.MaskedPattern = MaskedPattern;
    /** {@link MaskedNumber} */
    PicPayCCMask.MaskedNumber = MaskedNumber;
    /** {@link MaskedDate} */
    PicPayCCMask.MaskedDate = MaskedDate;
    /** {@link MaskedRegExp} */
    PicPayCCMask.MaskedRegExp = MaskedRegExp;
    /** {@link MaskedFunction} */
    PicPayCCMask.MaskedFunction = MaskedFunction;
    /** {@link MaskedDynamic} */
    PicPayCCMask.MaskedDynamic = MaskedDynamic;
    /** {@link createMask} */
    PicPayCCMask.createMask = createMask;
    /** {@link MaskElement} */
    PicPayCCMask.MaskElement = MaskElement;
    /** {@link HTMLMaskElement} */
    PicPayCCMask.HTMLMaskElement = HTMLMaskElement;

    g.PicPayCCMask = PicPayCCMask;
