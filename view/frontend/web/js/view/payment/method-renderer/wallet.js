    ...
    function ($, ko, Component, customer) {
        ...
        return Component.extend({
            ...
            hasInstructions: function () {
                return (window.checkoutConfig.payment.picpay_checkout_wallet.checkout_instructions.length > 0);
            },

            getInstructions: function () {
                return window.checkoutConfig.payment.picpay_checkout_wallet.checkout_instructions;
            }
        });
    }
);
